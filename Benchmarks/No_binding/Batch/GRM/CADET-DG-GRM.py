...
#Setting up the model
    ...
    model.root.input.model.unit_001.adsorption.lin_kd = [1]      #
...
c_analytical = pd.read_csv('Semi-analytical_GRM.csv')
...
runCadetDG("GRM", c_analytical, polyDeg, nCells, False, polyDegPore)
