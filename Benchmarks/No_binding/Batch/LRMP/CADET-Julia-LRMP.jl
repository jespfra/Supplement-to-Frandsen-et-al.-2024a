...
c_analytical = CSV.read((joinpath(@__DIR__,"Semi-analytical_LRMP.csv")),DataFrame)
...
inlets, outlets, columns, switches, solverOptions = model_setup(nCell[4],polyDeg[1], 0, true)
